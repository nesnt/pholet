...
export const DesignSpecView: React.FC = () => {
  return (
    <div className="space-y-8 max-w-5xl mx-auto py-2">
      ...
      {/* Title Header Banner */}
      <div className="bg-[#FF4C29] text-white rounded-2xl p-6 sm:p-8 border border-[#334756]/40 shadow-lg space-y-3 relative overflow-hidden">
        <div className="absolute top-0 right-0 -mr-12 -mt-12 w-48 h-48 bg-[#334756]/20 rounded-full blur-2xl pointer-events-none" />
        <div className="flex items-center gap-2 text-xs text-white font-mono tracking-widest uppercase font-semibold">
        ...
        <p className="text-xs sm:text-sm text-white/90 max-w-3xl leading-relaxed">
          Platform galeri foto analog & film dengan atmosfer <em className="font-serif-display text-white">"warm, earthy, vintage-film, artisanal"</em>. Dirancang khusus untuk fotografer yang menghargai kenangan foto yang pernah terlupakan.
        </p>
      </div>

      {/* Section 1: Typography */}
      <section className="bg-[#082032] rounded-2xl border border-[#334756]/30 p-6 shadow-sm space-y-4">
        <div className="flex items-center gap-2.5 text-white border-b border-[#334756]/20 pb-3">
          <Type className="w-5 h-5 text-[#FF4C29]" />
          <h2 className="font-serif-display text-xl font-bold">
            1. Rekomendasi Tipografi (Font Pairing)
          </h2>
        </div>

        <p className="text-xs text-gray-100/90 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Heading Font */}
          <div className="bg-[#2C394B]/40 border border-[#334756]/30 p-4 rounded-xl space-y-2">
            ...
            <p className="text-xs text-gray-100/80 font-sans leading-relaxed">
            ...
            <div className="pt-2 border-t border-[#334756]/20 text-xs font-serif-display text-white italic">
          ...
          <div className="bg-[#2C394B]/40 border border-[#334756]/30 p-4 rounded-xl space-y-2">
            ...
            <div className="pt-2 border-t border-[#334756]/20 text-xs font-mono text-white">
      ...
      <section className="bg-[#082032] rounded-2xl border border-[#334756]/30 p-6 shadow-sm space-y-4">
        <div className="flex items-center gap-2.5 text-white border-b border-[#334756]/20 pb-3">
          <Eye className="w-5 h-5 text-[#FF4C29]" />
          <h2 className="font-serif-display text-xl font-bold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-[#2C394B]/30 border border-[#334756]/20 p-4 rounded-xl space-y-2">
            <h3 className="font-serif-display font-bold text-white text-sm flex items-center gap-1.5">
              <Camera className="w-4 h-4 text-[#FF4C29]" />
              Homepage / Feed Komunitas
            </h3>
            <p className="text-xs text-gray-100/80 leading-relaxed">
          ...
          <div className="bg-[#2C394B]/30 border border-[#334756]/20 p-4 rounded-xl space-y-2">
            <h3 className="font-serif-display font-bold text-white text-sm flex items-center gap-1.5">
              <Sparkles className="w-4 h-4 text-[#FF4C29]" />
          ...
          <div className="bg-[#2C394B]/30 border border-[#334756]/20 p-4 rounded-xl space-y-2">
            <h3 className="font-serif-display font-bold text-white text-sm flex items-center gap-1.5">
              <Layers className="w-4 h-4 text-[#FF4C29]" />
      ...
      <section className="bg-[#082032] rounded-2xl border border-[#334756]/30 p-6 shadow-sm space-y-4">
        <div className="flex items-center gap-2.5 text-white border-b border-[#334756]/20 pb-3">
          <Layout className="w-5 h-5 text-[#FF4C29]" />
          <h2 className="font-serif-display text-xl font-bold">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          <div className="p-3 bg-[#2C394B]/40 border border-[#334756]/30 rounded-xl space-y-1">
            <h4 className="font-bold text-white flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-[#FF4C29]" />
          ...
          <div className="p-3 bg-[#2C394B]/40 border border-[#334756]/30 rounded-xl space-y-1">
            <h4 className="font-bold text-white flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-[#334756]" />
      ...
      <section className="bg-[#082032] rounded-2xl border border-[#334756]/30 p-6 shadow-sm space-y-4">
        <div className="flex items-center gap-2.5 text-white border-b border-[#334756]/20 pb-3">
          <Heart className="w-5 h-5 text-[#FF4C29] fill-rose-700" />
          <h2 className="font-serif-display text-xl font-bold">
            4. Micro-Animation Heart Burst Spec (Interaksi Suka)
          </h2>
        </div>

        <div className="bg-[#2C394B]/40 border border-[#334756]/30 p-4 rounded-xl space-y-3">
          <p className="text-xs text-gray-100/90 leading-relaxed">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center text-xs">
            <div className="p-2 bg-[#082032] border border-[#334756]/30 rounded-lg">
              <span className="font-bold text-white block">0%</span>
              <span className="text-[10px] text-gray-400">scale(1)</span>
            </div>
            <div className="p-2 bg-[#082032] border border-[#334756]/30 rounded-lg">
              <span className="font-bold text-white block">25%</span>
              <span className="text-[10px] text-gray-400">scale(1.35) rotate(-10deg)</span>
            </div>
            <div className="p-2 bg-[#082032] border border-[#334756]/30 rounded-lg">
              <span className="font-bold text-white block">50%</span>
              <span className="text-[10px] text-gray-400">scale(0.9) rotate(5deg)</span>
            </div>
            <div className="p-2 bg-[#082032] border border-[#334756]/30 rounded-lg">
              <span className="font-bold text-rose-700 block">100%</span>
              <span className="text-[10px] text-gray-400">scale(1) rotate(0deg)</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#082032] rounded-2xl border border-[#334756]/30 p-6 shadow-sm space-y-4">
        <div className="flex items-center gap-2.5 text-white border-b border-[#334756]/20 pb-3">
          <Palette className="w-5 h-5 text-[#FF4C29]" />
          <h2 className="font-serif-display text-xl font-bold">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
          ...
          {/* Color 1 */}
          <div className="rounded-xl overflow-hidden border border-[#334756]/30 shadow-xs">
            <div className="h-16 bg-[#FF4C29] text-white p-3 font-mono font-bold flex flex-col justify-between">
              <span>#622B14</span>
              <span className="text-[10px] font-sans opacity-90">Espresso / Coklat Tua</span>
            </div>
            <div className="p-3 bg-[#082032] space-y-1">
              <span className="font-bold text-white block">Peran UI:</span>
              <p className="text-[11px] text-gray-100/80">
          ...
          {/* Color 2 */}
          <div className="rounded-xl overflow-hidden border border-[#334756]/30 shadow-xs">
            <div className="h-16 bg-[#334756] text-white p-3 font-mono font-bold flex flex-col justify-between">
              <span>#995F2F</span>
          ...
          {/* Color 3 */}
          <div className="rounded-xl overflow-hidden border border-[#334756]/30 shadow-xs">
            <div className="h-16 bg-[#978F66] text-gray-100 p-3 font-mono font-bold flex flex-col justify-between">
              <span>#978F66</span>
          ...
          {/* Color 4 */}
          <div className="rounded-xl overflow-hidden border border-[#334756]/30 shadow-xs">
            <div className="h-16 bg-[#2C394B] text-white p-3 font-mono font-bold flex flex-col justify-between">
              <span>#E4D6A9</span>
        ...
        {/* Accessibility Note */}
        <div className="bg-[#2C394B]/50 border border-[#334756]/40 p-3.5 rounded-xl flex items-start gap-3 text-xs">
          <ShieldCheck className="w-5 h-5 text-[#FF4C29] shrink-0 mt-0.5" />
          <div className="space-y-1 text-gray-100">
            <span className="font-bold text-white">Jaminan Kontras Aksesibilitas (WCAG AA Standard)</span>
      ...
      <section className="bg-[#082032] rounded-2xl border border-[#334756]/30 p-6 shadow-sm space-y-4">
        <div className="flex items-center gap-2.5 text-white border-b border-[#334756]/20 pb-3">
          <Code2 className="w-5 h-5 text-[#FF4C29]" />
          <h2 className="font-serif-display text-xl font-bold">
        ...
        <div className="space-y-3 text-xs">
          ...
          <pre className="p-3.5 bg-[#082032] text-white rounded-xl font-mono text-[11px] overflow-x-auto leading-relaxed">
